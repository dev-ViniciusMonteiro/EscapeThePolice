...
public class ReactiveTarget : MonoBehaviour
{
    ...
    [SerializeField] private float _maxHealth;//vida do sujeito
    ...
    private void FixedUpdate(){
        if (IsAlive){
            if (Physics.OverlapSphereNonAlloc(this.gameObject.transform.position, _detectionRadius,_withinAggroColliders,_aggroLayerMask) > 0){
